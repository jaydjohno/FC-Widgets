...
?>
    ...
    <p>On this page you can see all stores and their current months figures, and also amend any of the banking figures if needed</p>
    
    <br>
    
    <label for="stores">Choose the store</label> <br>
