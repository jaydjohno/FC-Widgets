...
<p>On this page you can search sales, using a sale ID, or leave blank if you want to use filters and find all sales that match the filters</p>
    
<br>

<form class="search-sales"> 
    <div class="row">
        <div class="col-xs-6 col-md-4 center-block" style="float:none;">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Enter a sale ID to search for a sale by ID" id="salesearch"/>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#search-filters">Choose Search Filters</a>
                        </h4>
                    </div>
                    <div id="search-filters" class="panel-collapse collapse">
...
<script>
    ...
    jQuery(".submit-search").on("click", function(event)
    {
        ...
        var keyword = jQuery('#salesearch').val();
